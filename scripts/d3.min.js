!function () {
  ...
  function J(n, e) {
    ...
    return [e.clientX - a.left - n.clientLeft,
  ...
  function ht(n, t, e) {
    ...
    r = pt(r) * $a,
    i = pt(i) * Ba,
    new mt(dt(3.2404542 * u - 1.5371385 * r - 0.4985314 * i), dt( - 0.969266 * u + 1.8760108 * r + 0.041556 * i), dt(0.0556434 * u - 0.2040259 * r + 1.0572252 * i))
  }
  function gt(n, t, e) {
  ...
  function _t(n, t, e) {
    ...
    a = o - i,
    c = (o + i) / 2;
    return a ? (u = 0.5 > c ? a / (o + i)  : a / (2 - o - i), r = n == o ? (t - e) / a + (e > t ? 6 : 0)  : t == o ? (e - n) / a + 2 : (n - t) / a + 4, r *= 60)  : (r = 0 / 0, u = c > 0 && 1 > c ? 0 : r),
    new at(r, u, c)
  }
  function wt(n, t, e) {
    n = St(n),
  ...
  function Pt(n) {
    ...
    u = n.currency,
    i = r && e ? function (n, t) {
      for (var u = n.length, i = [
      ], o = 0, a = r[0], c = 0; u > 0 && a > 0 && (c + a + 1 > t && (a = Math.max(1, t - c)), i.push(n.substring(u -= a, u + a)), !((c += a + 1) > t)); ) a = r[o = (o + 1) % r.length];
...
function Ot(n) {
  function t(n) {
    function t(t) {
      for (var e, u, i, o = [
      ], a = - 1, c = 0; ++a < r; ) 37 === n.charCodeAt(a) && (o.push(n.slice(c, a)), null != (u = sc[e = n.charAt(++a)]) && (e = n.charAt(++a)), (i = N[e]) && (e = i(t, null == u ? 'e' === e ? ' ' : '0' : u)), o.push(e), c = a + 1);
...
function ze(n) {
  if (t = n.length) {
    for (var t, e, r = 0, u = n[0]; ++r < t; ) u.n = e = n[r],
    e.p = u,
    u = e;
    u.n = e = n[0],
    e.p = u
...
function hr(n, t) {
  function e(n, t) {
    ...
    l = Math.sin(t),
    s = l * r + a * u;
    return [Math.atan2(c * i - s * o, a * r - l * u),
    tt(s * i + c * o)]
  }
  var r = Math.cos(n),
  u = Math.sin(n),
  ...
  return e.invert = function (n, t) {
    ...
    l = Math.sin(t),
    s = l * i - c * o;
    return [Math.atan2(c * i + l * o, a * r + s * u),
    tt(s * r - a * u)]
  },
  e
}
function gr(n, t) {
  ...
  return function (u, i, o, a) {
    ...
    for (var l, s = u; o > 0 ? s > i : i > s; s -= c) a.point((l = xe([e,
    - r * Math.cos(s),
    - r * Math.sin(s)])) [0], l[1])
  }
}
...
function Er(n, t) {
  return [Math.log(Math.tan(qa / 4 + t / 2)),
  - n]
}
function Ar(n) {
  return n[0]
...
function iu(n, t) {
  ...
  i = n.sort(ou).pop();
  for (Gc = [
  ], Kc = new Array(n.length), Qc = new nu, tl = new nu; ; ) if (u = nl, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x)) (i.x !== e || i.y !== r) && (Kc[i.i] = new Or(i), jr(i), e = i.x, r = i.y),
  i = n.pop();
   else {
    if (!u) break;
    Ur(u.arc)
...
function hu(n, t, e, r, u, i, o) {
  ...
  return function l(n, s, f, h, g) {
    if (!(s > i || f > o || r > h || u > g)) {
      ...
      for (var M = n.nodes, x = 0.5 * (s + h), b = 0.5 * (f + g), _ = t >= x, w = e >= b, S = w << 1 | _, k = S + 4; k > S; ++S) if (n = M[3 & S]) switch (3 & S) {
        case 0:
          l(n, s, f, x, b);
          break;
        case 1:
...
function du(n, t) {
  ...
  a.length < 2 ? c[0] ? (t = c[0].x, function (n) {
    return t(n) + ''
  })  : function () {
    return t
  }
...
function Yu(n) {
  for (var t = n.source, e = n.target, r = Vu(t, e), u = [
    t
  ]; t !== r; ) t = t.parent,
  u.push(t);
...
function Qu(n, t) {
  ...
  ]; null != (n = e.pop()); ) if (r.push(n), (i = n.children) && (u = i.length)) for (var u, i, o = - 1; ++o < u; ) e.push(i[o]);
...
function Ni(n) {
  for (var t, e = 0, r = 0, u = n.children, i = u.length; --i >= 0; ) t = u[i],
  t.z += e,
  t.m += e,
  e += t.s + (r += t.c)
}
...
function Vi(n, t) {
  ...
  i = t / r * u;
  return 0.15 >= i ? u *= 10 : 0.35 >= i ? u *= 5 : 0.75 >= i && (u *= 2),
...
function ho(n) {
  function t(t) {
    ...
    ], f = - 1, h = t.length, g = Et(e), p = Et(r); ++f < h; ) u.call(this, c = t[f], f) ? s.push([ + g.call(this, c, f),
...
function vo(n) {
  for (var t = 0, e = n.length, r = n[0], u = [
    ...
    ',',
    r[1]
  ]; ++t < e; ) u.push('H', (r[0] + (r = n[t]) [0]) / 2, 'V', r[1]);
...
function xo(n, t) {
  return n.length < 3 ? go(n)  : n[0] + _o((n.push(n[0]), n), wo([n[n.length - 2]].concat(n, [
    n[1]
  ]), t))
}
function bo(n, t) {
...
function wo(n, t) {
  for (var e, r = [
  ], u = (1 - t) / 2, i = n[0], o = n[1], a = 1, c = n.length; ++a < c; ) e = i,
  i = o,
  o = n[a],
  r.push([u * (o[0] - e[0]),
  u * (o[1] - e[1])]);
...
function Eo(n) {
  for (var t, e, r = - 1, u = n.length, i = u + 4, o = [
  ], a = [
  ]; ++r < 4; ) e = n[r % u],
  o.push(e[0]),
  a.push(e[1]);
...
function qo(n) {
  for (var t = 0, e = n.length - 1, r = [
  ], u = n[0], i = n[1], o = r[0] = zo(u, i); ++t < e; ) r[t] = (o + (o = zo(u = i, i = n[t + 1]))) / 2;
  return r[t] = o,
  r
}
function Lo(n) {
  for (var t, e, r, u, i = [
  ], o = qo(n), a = - 1, c = n.length - 1; ++a < c; ) t = zo(n[a], n[a + 1]),
...
function Ro(n) {
  for (var t, e, r, u = - 1, i = n.length; ++u < i; ) t = n[u],
  e = t[0],
  r = t[1] - Ra,
  t[0] = e * Math.cos(r),
  t[1] = e * Math.sin(r);
...
function Do(n) {
  function t(t) {
    ...
    ], y = - 1, M = t.length, x = Et(e), b = Et(u), _ = e === r ? function () {
      return g
    }
     : Et(r), w = u === i ? function () {
      return p
    }
     : Et(i); ++y < M; ) o.call(this, h = t[y], y) ? (d.push([g = + x.call(this, h, y),
    p = + b.call(this, h, y)]), m.push([ + _.call(this, h, y),
    + w.call(this, h, y)]))  : d.length && (c(), d = [
    ], m = [
    ]);
    return d.length && c(),
...
ta.pairs = function (n) {
  for (var t, e = 0, r = n.length - 1, u = n[0], i = new Array(0 > r ? 0 : r); r > e; ) i[e] = [
    t = u,
    u = n[++e]
  ];
  return i
...
ta.nest = function () {
  function n(t, o, a) {
    ...
    for (var c, s, f, h, g = - 1, p = o.length, v = i[a++], d = new l; ++g < p; ) (h = d.get(c = v(s = o[g]))) ? h.push(s)  : d.set(c, [
      s
    ]);
...
ta.select = function (t) {
  ...
  return 'string' == typeof t ? (e = [
    Ma(t, ua)
  ], e.parentNode = ua.documentElement)  : (e = [
    t
  ], e.parentNode = n(t)),
  A([e])
},
...
ta.behavior.zoom = function () {
  ...
  n.event = function (n) {
    n.each(function () {
      ...
      Tl ? ta.select(this).transition().each('start.zoom', function () {
        ...
        u = d ? d[0] : e / 2,
        i = d ? d[1] : r / 2,
        o = ta.interpolateZoom([(u - k.x) / k.k,
        (i - k.y) / k.k,
        e / k.k], [
          (u - t.x) / t.k,
          (i - t.y) / t.k,
  ...
  n.center = function (t) {
    return arguments.length ? (m = t && [ + t[0],
    + t[1]], n)  : m
  },
  n.size = function (t) {
    return arguments.length ? (A = t && [ + t[0],
    + t[1]], n)  : A
  },
...
Ya.brighter = function (n) {
  return n = Math.pow(0.7, arguments.length ? n : 1),
...
dc = {
  ...
  MultiPoint: function (n, t) {
    for (var e = n.coordinates, r = - 1, u = e.length; ++r < u; ) n = e[r],
    t.point(n[0], n[1], n[2])
  },
...
ta.geo.albers = function () {
  return ta.geo.conicEqualArea().rotate([96,
  0]).center([ - 0.6,
  38.7]).parallels([29.5,
  45.5]).scale(1070)
},
ta.geo.albersUsa = function () {
  ...
  u,
  i = ta.geo.albers(),
  o = ta.geo.conicEqualArea().rotate([154,
  0]).center([ - 2,
  58.5]).parallels([55,
  65]),
  a = ta.geo.conicEqualArea().rotate([157,
  0]).center([ - 3,
  19.9]).parallels([8,
  18]),
  c = {
  ...
  n.translate = function (t) {
    ...
    s = + t[0],
    f = + t[1];
    return e = i.translate(t).clipExtent([[s - 0.455 * l,
    f - 0.238 * l],
    [
      s + 0.455 * l,
      f + 0.238 * l
    ]]).stream(c).point,
    r = o.translate([s - 0.307 * l,
    f + 0.201 * l]).clipExtent([[s - 0.425 * l + Ca,
    f + 0.12 * l + Ca],
    [
      s - 0.214 * l - Ca,
      f + 0.234 * l - Ca
    ]]).stream(c).point,
    u = a.translate([s - 0.205 * l,
    f + 0.212 * l]).clipExtent([[s - 0.214 * l + Ca,
    f + 0.166 * l + Ca],
    [
      s - 0.115 * l - Ca,
      f + 0.234 * l - Ca
...
ta.geom.hull = function (n) {
  function t(n) {
    ...
    for (t = 0; o > t; t++) a.push([ + u.call(this, n[t], t),
    + i.call(this, n[t], t),
    t]);
    for (a.sort(zr), t = 0; o > t; t++) c.push([a[t][0],
    - a[t][1]]);
    var l = Cr(a),
    s = Cr(c),
    f = s[0] === l[0],
...
Jc.area = function () {
  for (var n, t = - 1, e = this.length, r = this[e - 1], u = 0; ++t < e; ) n = r,
  r = this[t],
  u += n[1] * r[0] - n[0] * r[1];
  return 0.5 * u
},
...
Or.prototype.prepare = function () {
  for (var n, t = this.edges, e = t.length; e--; ) n = t[e].edge,
...
ta.geom.voronoi = function (n) {
  ...
  return n ? t(n)  : (t.links = function (n) {
    ...
    return iu(e(n)).cells.forEach(function (e, r) {
      ...
      s = a[c].edge,
      f = s.l === o ? s.r : s.l,
      r < i.i && r < f.i && au(o, i, f) < 0 && t.push([n[r],
      n[i.i],
      n[f.i]])
    }),
    t
    ...
    return arguments.length ? t.clipExtent(n && [[0,
    0],
    n])  : a === ul ? null : a && a[1]
  }, t)
};
  ...
  function i(n) {
    function i(n, t, e, r, u, i, o, a) {
      if (!isNaN(e) && !isNaN(r)) if (n.leaf) {
        var c = n.x,
        s = n.y;
        if (null != c) if (ga(c - e) + ga(s - r) < 0.01) l(n, t, e, r, u, i, o, a);
         else {
          var f = n.point;
    ...
    m = r,
    y = u;
     else if (m = y = - (v = d = 1 / 0), f = [
    ], h = [
    ], p = n.length, o) for (g = 0; p > g; ++g) s = n[g],
    s.x < v && (v = s.x),
    s.y < d && (d = s.y),
    s.x > m && (m = s.x),
    s.y > y && (y = s.y),
...
ta.layout.bundle = function () {
  return function (n) {
    for (var t = [
    ], e = - 1, r = n.length; ++e < r; ) t.push(Yu(n[e]));
    return t
  }
},
...
ta.layout.force = function () {
  ...
  a.start = function () {
    ...
    isNaN(r.py) && (r.py = r.y);
    if (u = [
    ], 'function' == typeof f) for (t = 0; s > t; ++t) u[t] = + f.call(this, M[t], t);
     else for (t = 0; s > t; ++t) u[t] = f;
    if (i = [
    ], 'function' == typeof h) for (t = 0; s > t; ++t) i[t] = + h.call(this, M[t], t);
     else for (t = 0; s > t; ++t) i[t] = h;
    if (o = [
    ], 'function' == typeof g) for (t = 0; c > t; ++t) o[t] = + g.call(this, m[t], t);
...
ta.layout.histogram = function () {
  function n(n, i) {
    for (var o, a, c = [
    ], l = n.map(e, this), s = r.call(this, l, i), f = u.call(this, s, l, i), i = - 1, h = l.length, g = f.length - 1, p = t ? 1 : 1 / h; ++i < g; ) o = c[i] = [
    ],
    o.dx = f[i + 1] - (o.x = f[i]),
    o.y = 0;
...
ta.layout.tree = function () {
  ...
  function t(n) {
    for (var t, e = {
      ...
      e
    ]; null != (t = r.pop()); ) for (var u, i = t.children, o = 0, a = i.length; a > o; ++o) r.push((i[o] = u = {
      _: i[o],
      parent: t,
...
ta.scale.log = function () {
  return Ji(ta.scale.linear().domain([0,
  1]), 10, !0, [
    1,
    10
  ])
...
Pl.selectAll = function (n) {
  ...
  for (var l = - 1, s = this.length; ++l < s; ) for (var f = this[l], h = - 1, g = f.length; ++h < g; ) if (r = f[h]) {
    ...
    for (var p = - 1, v = e.length; ++p < v; ) (u = e[p]) && $o(u, p, a, o, i),
    t.push(u)
  }
  return Yo(c, a, o)
},
...
Pl.transition = function () {
  for (var n, t, e, r, u = this.id, i = ++Ul, o = this.namespace, a = [
  ], c = 0, l = this.length; l > c; c++) {
    a.push(n = [
    ]);
...
ta.svg.brush = function () {
  ...
  function i() {
    ...
    function d() {
      ...
      t = !1;
      x && (n[0] += x[0], n[1] += x[1]),
      C || (ta.event.altKey ? (M || (M = [
        (f[0] + f[1]) / 2,
        (h[0] + h[1]) / 2
      ]), q[0] = f[ + (n[0] < M[0])], q[1] = h[ + (n[1] < M[1])])  : M = null),
      A && m(n, l, 0) && (r(k), t = !0),
      N && m(n, s, 1) && (u(k), t = !0),
      t && (e(k), w({
        type: 'brush',
